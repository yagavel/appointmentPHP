            ...
            <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
                    ...
                    <div class="row frame-content">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="first-name" value="Yagavel" class="required form-control" maxlength="100"/>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="last-name" class="required form-control" maxlength="120" value="P" />
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="email" class="required form-control" maxlength="120" value="yaga@gmail.com" />
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="phone-number" value="9159518823" maxlength="60"
                ...
                <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                    <div class="frame-container">
                        ...
                        <div class="row frame-content">
                            <div id="appointment-details" class="col-12 text-center"></div>
                    ...
                    <div class="command-buttons">
                        ...
                        <form id="book-appointment-form" style="display:inline-block" method="post">
                            <a href="http://localhost/easyappointments/index.php/appointments/payment"
                                class="btn btn-primary float-right buy_now" data-amount="1280" data-id="2">Proceed to
                                Pay</a>
                            </button>
                ...
                <div id="frame-footer">
                    <small>
                        <span class="footer-powered-by">
                            ...
                            <a href="https://easyappointments.org" target="_blank">Appointments</a>
                        </span>
